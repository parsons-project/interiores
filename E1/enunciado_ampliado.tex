...
\newpar
Se incluye un catálogo de habitaciones por defecto (ver anexo Z) que siempre
estará disponible. Si el usuario realiza cambios sobre el catálogo por
defecto y decide guardar los cambios se le preguntará dónde desea guardar
el catálogo. Por ende, el usuario también podrá cargar catálogos desde un
archivo que haya guardado previamente, o bien, volver al catálogo por defecto.
\newpar
...
\begin{description}
  ...
  a la habitación o a modelos de muebles. Más información en
  \nameref{restricciones}.
\end{description}
...
manera más exacta la forma de la habitación que se quiere diseñar. Los
accidentes no son redistribuidos cuando la aplicación genera el diseño de la
habitación.
\newpar
Al añadir accidentes el usuario debe determinar la posición del accidente y
sus dimensiones. En el mapa de la habitación los accidentes tienen forma
rectangular.
...
\begin{description}
  ...
  \item[Dimensiones] Las dimensiones del mueble: ancho y largo. Además se
  tiene en cuenta la altura.
  ...
  \item[Espacio pasivo] Es el espacio que es necesario para que el mueble
  sea utilizado. Este espacio puede superponerse con el de otros muebles.
  ...
  \item[Plazas] Personas que pueden utilizar el mueble al mismo tiempo.
...
\newpar
Se incluye un catálogo de muebles por defecto (ver anexo Y) que siempre
estará disponible. Si el usuario realiza cambios sobre el catálogo por
defecto y decide guardar los cambios se le preguntará dónde desea guardar
el catálogo. Por ende, el usuario también podrá cargar catálogos desde un
archivo que haya guardado previamente, o bien, volver al catálogo por defecto.
...
Adicionalmente, si se dispone del tiempo suficiente se intentarán implementar
...
\begin{description}
  ...
  sobre todo para hacer debugging sin necesidad de interfaz gráfica
