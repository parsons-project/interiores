\subsubsection{Diseñar una habitación}
...
\item[Especificar la topología] Determinar la topología de
  ...
  \begin{description}
    \item[Especificar tipo] El usuario escoge un tipo de habitación de
      entre todos los disponibles.
    \item[Especificar dimensiones] El usuario indica las medidas de la
      habitación. Ésta tendrá forma rectangular.
    \item[Colocar elemento fijo] El usuario selecciona un elemento
...
\item[Especificar restricciones]
  ...
  \end{description}
\item[Generar una distribución automática de los muebles] El usuario
...
\end{description}
\subsubsection{Gestionar catálogo de muebles}
...
\begin{description}
  ...
  \item[Cargar catálogo]El usuario importa desde un fichero externo un
...
\end{description}
\subsubsection{Gestionar catálogo de habitaciones}
