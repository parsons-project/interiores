...
seleccionar el mueble o elemento fijo que desee añadir y hacer click en la
...
\begin{description}
  \item[Dimensiones] Ancho, largo y alto, en centímetros.
...
\begin{description}
  ...
  \item[Elementos fijos] A través del menú de elementos fijos.
...
\begin{description}
  ...
  \item[Dimensiones máximas y mínimas] Ancho, largo y alto máximos y mínimos
...
\begin{description}
  ...
  muebles y elementos fijos, enchufes e interruptores en la habitación. Los
  muebles tendrán en cuenta estos elementos para no tapar los interruptores y
