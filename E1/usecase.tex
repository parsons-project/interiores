...
\begin{description}
\item[Cargar diseño] El usuario carga, desde un fichero de texto, un conjunto 
de parámetros que determinan el estado de un diseño (en cualquiera de sus fases).
Esto significa:
\begin{enumerate}
\item Que el usuario puede guardar su progreso en cualquier punto y volver a él más adelante.
\item Que el usuario puede manejar el programa de manera textual a través de comandos y parámetros.
\end{enumerate}
...
\item[Guardar diseño] El usuario guarda el estado del diseño actual de la 
habitación en un fichero de texto. Este fichero contiene los comandos y 
parámetros que el usuario ha empleado de manera gráfica con tal de llegar 
al punto actual. Así pues, un usuario puede trabajar en un mismo diseño 
en días diferentes u ordenadores diferentes, y puede compartir con otras 
personas sus diseños, para que estos los reaprovechen.
