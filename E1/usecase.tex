...
Esto significa:
1) Que el usuario puede guardar su progreso en cualquier punto y volver a él más adelante.
2) Que el usuario puede manejar el programa de manera textual a través de comandos y parámetros.
