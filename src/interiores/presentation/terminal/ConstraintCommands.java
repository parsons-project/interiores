...
public class ConstraintCommands extends CommandGroup {
    ...
    public void add() throws ClassNotFoundException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, Exception {
        ...
        if (isBinary(type)) {
            ...
            else throw new Exception(type + "constraint doesn't exist");
