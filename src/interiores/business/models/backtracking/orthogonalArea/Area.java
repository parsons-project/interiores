 ...
 * The coordinate origin is the top left square of the plane.
 * 
...
public class Area {
    ...
    public boolean contains(Point point) {
        ...
        RightRay ray = new RightRay(point);
    ...
    public void union(Area a) {
        ...
        //2) find vextexs that have an odd number of adjacent contained points
        // in either area
    ...
    private boolean contains(GridPoint point) {
        ...
        List<Point> adjacentPoints = adjacentPoints(point);
        for (Point p : adjacentPoints)
    ...
    public Area shiftedArea(int distance, Orientation orientation) {
        ...
        if (orientation == Orientation.W && distance > boundingRectangle.x) {
            ...
            //remove dead zone
            newArea.difference(new Area(deadZone));
        }
