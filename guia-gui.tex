...
Para editar las restricciones globales, se puede acceder a un editor parecido
al de las restricciones de mueble usando el botón 'Global constraints', con el icono
de un candado. Tiene las mismas funcionalidades: a\~{n}adir restricciones y quitar
restricciones (pulsando la tecla 'SUPR').
