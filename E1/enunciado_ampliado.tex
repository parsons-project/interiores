...
\begin{description}
  ...
  a la habitación o a modelos de muebles y sus propiedades. Más información en
  \nameref{restricciones}.
\end{description}
...
El tipo del modelo de un mueble especifica las utilidades implícitas del
mueble. El usuario podrá modificar los tipos de muebles disponibles, así como
definir nuevos tipos indicando sus utilidades.
\newpar
El modelo del mueble se especializa en función de las utilidades del tipo de
mueble, adquiriendo nuevas propiedades. Las utilidades disponibles son:
\begin{description}
  ...
  \item[Lugar para dormir] Las personas pueden dormir en el mueble. Añade la
  propiedad: número de plazas.
...
Para una lista detallada de los tipos de muebles disponibles consultar
\nameref{anexo_tipos}.
...
\begin{description}
  ...
  \item[Propiedades de los modelos de muebles] La habitación puede contener
  restricciones que obliguen o prohiban la inclusión de cierto tipo de mueble
  al diseño, por ejemplo.
\end{description}
