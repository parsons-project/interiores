...
Son elementos fijos los accidentes, los radiadores, las ventanas y las
puertas.
\newpar
...
rectangular, mientras que las puertas, ventanas y radiadores se representan
gráficamente igual que en diseños arquitectónicos.
...
\subsubsection{Los tipos de modelos de muebles}
\label{tipos}
Los tipos de modelos de muebles se utilizan para clasificar y definir los
modelos más fácilmente. El tipo del modelo de un mueble especifica:
\begin{description}
  \item[Dimensiones máximas y mínimas] En centímetros.
  \item[Utilidades] El modelo se especializará en función de las utilidades
  del tipo de mueble, adquiriendo nuevas propiedades.
...
\begin{description}
  ...
  \item[Tipos de modelos de muebles] Una cocina debe tener como mínimo una
  ventana, por ejemplo.
\end{description}
